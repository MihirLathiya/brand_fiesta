...
class _AddDetailsScreenState extends State<AddDetailsScreen> {
  AddDetailsController addDetailsController = Get.find();
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
            backgroundColor: AppColor.black, elevation: 0, leading: SizedBox()),
        bottomNavigationBar: GetBuilder<AddDetailsController>(
          builder: (controller) {
            return Padding(
        ...
        body: GetBuilder<AddDetailsController>(
          builder: (controller) {
            return Column(
              children: [
                _appBar(font),
  ...
  Container _addImage(
      double size, double font, AddDetailsController controller) {
    return Container(
      height: size * 125,
      width: Get.width,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style:
                          TextStyle(fontSize: font * 14, color: AppColor.white),
                    ),
                  ],
                ),
